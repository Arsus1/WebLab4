...
export function Graph(props) {
    ...
    const drawPoint = (_x, _y, _r, _result) => {
        ...
        let y = Number(_y);
        let r = Number(_r);
        let color = _result ? "#03bf03" : "#BF0B10";
    ...
    return (
        <div>
            <svg ref={graph} onClick={event => handleClick(event)} className="graph content"
                ...
                <polygon className="rectangle-graph" fill="#e83e8c"
                         fillOpacity="0.5" points="290,200 290,380 200,380 200,200" stroke="#e83e8c"/>
                <polygon className="triangle-graph" fill="#e83e8c"
                         fillOpacity="0.5" points="20,200 200,20 200,200" stroke="#e83e8c"/>
                <path className="circle-graph" d="M 380 200 A 180 180 0 0 0 200 20 L 200 200 Z"
                      fill="#e83e8c" fillOpacity="0.5" stroke="#e83e8c"/>
            </svg>
        </div>
    )
}
